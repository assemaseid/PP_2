...
def update_food_pos(snake_body):
    ...
    food_pos = [
        random.randrange(2, (screen_width // snake_block_size)-3) * snake_block_size,
        random.randrange(4, (screen_height // snake_block_size)-3) * snake_block_size
    ]
    food_pos_2 = [
        random.randrange(2, (screen_width // snake_block_size)-3) * snake_block_size,
        random.randrange(4, (screen_height // snake_block_size)-3) * snake_block_size
...
def check_wall_collision(snake_pos, level):
    ...
    if level >= 2:
        ...
        rock_wall_positions = [
            (range(60, screen_width // 3), range(screen_height // 2 - 16, screen_height // 2 + 16)),  # Top-left rock wall
            (range(screen_width // 2 - 16, screen_width // 2 + 16), range(89, screen_height // 3)),   # Top-right rock wall
            (range(screen_width // 2 - 16, screen_width // 2 + 16), range(screen_height - screen_height // 3 - 32, screen_height - 64)),  # Bottom-right rock wall
            (range(screen_width - screen_width // 3 - 32, screen_width - 50), range(screen_height // 2 - 16, screen_height // 2 + 16))    # Bottom-left rock wall
            ]
